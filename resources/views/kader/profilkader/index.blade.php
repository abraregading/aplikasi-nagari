...
@section('title', 'Profil Saya - Kader')
...
<div class="profile-card">
    ...
    @if($user->posyandu)
        <div style="margin-top: 0.75rem; font-size: 0.9rem; opacity: 0.9;">
            <i class="ri-hospital-line"></i> {{ $user->posyandu->nama_posyandu }}
        </div>
    @endif
</div>
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(400px, 1fr)); gap: 2rem;">
    ...
    <div class="glass" style="padding: 2rem; border-radius: 16px;">
        ...
        <form action="{{ route('kader.profil.updateProfile') }}" method="POST">
            @csrf
            @method('PUT')
    ...
    <div class="glass" style="padding: 2rem; border-radius: 16px;">
        ...
        <form action="{{ route('kader.profil.updatePassword') }}" method="POST">
            @csrf
            @method('PUT')
