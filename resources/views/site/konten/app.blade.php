...
<body>
    ...
    <nav class="navbar" style="background-color: var(--primary-color);">
        <div class="logo">
            ...
            <span style="color: white;">{{ $profilnagari['nama_pemerintahan'] ?? 'Desa' }}<span style="color: var(--accent-color);"> Digital</span></span>
        </div>
        <div class="hamburger" style="color: white;">
            <i class="fa-solid fa-bars"></i>
        </div>
        @include('site.layouts.partials.navbar1')
    </nav>
    ...
    <footer id="contact" class="footer">
        @include('site.layouts.partials.footer.index1')
    </footer>
