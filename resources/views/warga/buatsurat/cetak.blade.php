...
<body>
    ...
    <div class="toolbar">
        ...
        <a href="{{ route('buatsurat.proses') }}" class="btn-kembali">
            Kembali ke Proses
        </a>
    ...
    <div class="page">
        ...
        <div class="isi-surat">
            ...
            <p>Adalah benar warga/penduduk Nagari {{ ucwords(strtolower($profil['nama_nagari'] ?? 'Kuamang Alai Ujung Gading')) }} dan benar dalam keadaan <span class="bold">{{ ucwords(strtolower($surat->keterangan ?? '....')) }}</span>.</p>
        ...
        <div class="ttd-section">
            <div class="ttd-wrapper">
                <div class="tanggal-surat">{{ ucwords(strtolower($profil['nama_nagari'] ?? 'Kuamang Alai Ujung Gading')) }}, {{ $surat->tanggal_pengantar ? \Carbon\Carbon::parse($surat->tanggal_pengantar)->isoFormat('D MMMM Y') : now()->isoFormat('D MMMM Y') }}</div>
