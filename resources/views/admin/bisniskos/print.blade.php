...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .badge-kos { background: #e0e7ff; color: #4338ca; }
        .badge-kontrakan { background: #d1fae5; color: #065f46; }
        .badge-rumah_petak { background: #fef3c7; color: #92400e; }
...
<body>
    ...
    <div class="footer">
        ...
        <p>{{ config('app.name', 'Si YanDuk') }} - Nagari {{ $profil['nama_nagari'] ?? 'Nagari' }}</p>
    </div>

    <div class="no-print">
        <button class="btn-print" onclick="window.print()">Print / Cetak</button>
        <button class="btn-pdf" onclick="window.close()">Tutup</button>
    </div>
</body>
</html>