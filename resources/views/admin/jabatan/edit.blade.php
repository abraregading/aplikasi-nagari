...
@section('title', 'Edit Jabatan - Admin Desa')
...
<div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 2rem;">
    ...
    <h2 style="margin: 0;">Edit Jabatan</h2>
</div>
...
<div class="glass" style="padding: 2rem; border-radius: 16px;">
    <form action="{{ route('jabatan.update', $jabatan->id) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" id="nama_jabatan" name="nama_jabatan" value="{{ old('nama_jabatan', $jabatan->nama_jabatan) }}" placeholder="Contoh: Kepala Desa" class="glass-select" style="width: 100%;" required>
            @error('nama_jabatan')
        ...
        <div class="form-actions">
            ...
            <a href="{{ route('jabatan.index') }}" class="glass-select" style="background: transparent; color: var(--text-main); border: 1px solid var(--text-muted); padding: 0.8rem 1.5rem; font-weight: 500; text-decoration: none; display: inline-flex; align-items: center; gap: 0.5rem;">
