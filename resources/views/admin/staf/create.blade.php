...
@section('title', 'Tambah Staf - Admin Desa')
...
<div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 2rem;">
    ...
    <h2 style="margin: 0;">Tambah Staf</h2>
</div>
        ...
        <div class="row">
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="text" id="profil" name="profil" value="{{ old('profil') }}" placeholder="Isikan profil staf disini.." class="glass-select" style="width: 100%;">
                    @error('profil')
                        <span class="error-text">{{ $message }}</span>
                    @enderror
                </div>
