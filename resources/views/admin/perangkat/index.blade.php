...
@section('title', 'Dashboard Data Perangkat - Admin Desa')
...
@section('konten')
<h2 style="margin-bottom: 2rem;">Data Perangkat</h2>
  ...
  <div class="glass" style="padding: 2rem; border-radius: 16px;">
      <a href="{{ route('perangkat.create') }}" class="glass-select" style="background: var(--primary); color: white; border: none; padding: 0.8rem 1.5rem; font-weight: 500; text-decoration: none; display: inline-flex; align-items: center; gap: 0.5rem;">
                  ...
                  <tr>
                      ...
                      <td>
                          <div style="display: flex; gap: 0.5rem; flex-wrap: wrap;">
                              <a href="{{ route('perangkat.edit', $item->id) }}" class="glass-select" style="background: rgba(245, 158, 11, 0.15); color: #f59e0b; border: 1px solid rgba(245, 158, 11, 0.25); padding: 0.4rem 0.8rem; font-size: 0.8rem; font-weight: 500; text-decoration: none; display: inline-flex; align-items: center; gap: 0.3rem;">
                                  <i class="ri-edit-line"></i> Edit
                              </a>
                              <form action="{{ route('perangkat.destroy', $item->id) }}" method="POST" style="display: inline;" onsubmit="return confirm('Apakah Anda yakin ingin menghapus perangkat ini?')">
                                  @csrf
                                  @method('DELETE')
