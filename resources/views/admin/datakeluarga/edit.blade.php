...
@section('title', 'Edit Data Keluarga - Admin Desa')
...
<div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 2rem;">
    ...
    <h2 style="margin: 0;">Edit Data Keluarga</h2>
</div>
...
<div class="glass" style="padding: 2rem; border-radius: 16px;">
    <form action="{{ route('data-keluarga.update', $keluarga->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" id="jorong" name="jorong" value="{{ old('jorong', $keluarga->jorong) }}" placeholder="Nama Jorong" class="glass-select" style="width: 100%;" maxlength="50">
                @error('jorong')
                    <span class="error-text">{{ $message }}</span>
                @enderror
            </div>
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" id="desa_kelurahan" name="desa_kelurahan" value="{{ old('desa_kelurahan', $keluarga->desa_kelurahan) }}" placeholder="Masukkan nama desa/kelurahan" class="glass-select" style="width: 100%;" maxlength="50">
            ...
            <div class="form-group">
                ...
                <input type="text" id="kecamatan" name="kecamatan" value="{{ old('kecamatan', $keluarga->kecamatan) }}" placeholder="Masukkan kecamatan" class="glass-select" style="width: 100%;" maxlength="50">
                @error('kecamatan')
                    <span class="error-text">{{ $message }}</span>
                @enderror
            </div>
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" id="kabupaten_kota" name="kabupaten_kota" value="{{ old('kabupaten_kota', $keluarga->kabupaten_kota) }}" placeholder="Masukkan kabupaten/kota" class="glass-select" style="width: 100%;" maxlength="50">
            ...
            <div class="form-group">
                ...
                <input type="text" id="provinsi" name="provinsi" value="{{ old('provinsi', $keluarga->provinsi) }}" placeholder="Masukkan provinsi" class="glass-select" style="width: 100%;" maxlength="50">
                @error('provinsi')
                    <span class="error-text">{{ $message }}</span>
                @enderror
            </div>
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" id="kode_pos" name="kode_pos" value="{{ old('kode_pos', $keluarga->kode_pos) }}" placeholder="Masukkan kode pos" class="glass-select" style="width: 100%;" maxlength="10">
                @error('kode_pos')
                    <span class="error-text">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" id="jumlah_anggota" name="jumlah_anggota" value="{{ old('jumlah_anggota', $keluarga->jumlah_anggota) }}" placeholder="0" class="glass-select" style="width: 100%;" min="0">
