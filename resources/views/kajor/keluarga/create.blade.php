...
@section('title', 'Tambah Keluarga - Jorong ' . $jorongName)
...
<div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 2rem;">
    <a href="{{ route('kajor.keluarga.index') }}" class="glass-select" style="background: transparent; color: var(--text-main); border: 1px solid var(--text-muted); padding: 0.5rem 1rem; font-weight: 500; text-decoration: none; display: inline-flex; align-items: center; gap: 0.4rem;">
        <i class="ri-arrow-left-line"></i> Kembali
    </a>
    <h2 style="margin: 0;">Tambah Keluarga</h2>
</div>
...
<div class="glass" style="padding: 2rem; border-radius: 16px;">
    <form action="{{ route('kajor.keluarga.store') }}" method="POST">
        @csrf
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" id="desa_kelurahan" name="desa_kelurahan" value="{{ old('desa_kelurahan') }}" placeholder="Nama desa/kelurahan" class="glass-select" style="width: 100%;" maxlength="50">
                @error('desa_kelurahan') <span class="error-text">{{ $message }}</span> @enderror
            </div>
            <div class="form-group">
                <label for="kecamatan">Kecamatan</label>
                <input type="text" id="kecamatan" name="kecamatan" value="{{ old('kecamatan') }}" placeholder="Nama kecamatan" class="glass-select" style="width: 100%;" maxlength="50">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" id="kabupaten_kota" name="kabupaten_kota" value="{{ old('kabupaten_kota') }}" placeholder="Nama kabupaten/kota" class="glass-select" style="width: 100%;" maxlength="50">
                @error('kabupaten_kota') <span class="error-text">{{ $message }}</span> @enderror
            </div>
            <div class="form-group">
                <label for="provinsi">Provinsi</label>
                <input type="text" id="provinsi" name="provinsi" value="{{ old('provinsi') }}" placeholder="Nama provinsi" class="glass-select" style="width: 100%;" maxlength="50">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" id="kode_pos" name="kode_pos" value="{{ old('kode_pos') }}" placeholder="Kode pos" class="glass-select" style="width: 100%;" maxlength="10">
                @error('kode_pos') <span class="error-text">{{ $message }}</span> @enderror
            </div>
            <div class="form-group">
                <label for="jumlah_anggota">Jumlah Anggota</label>
                <input type="number" id="jumlah_anggota" name="jumlah_anggota" value="{{ old('jumlah_anggota', 0) }}" class="glass-select" style="width: 100%;" min="0">
        ...
        <div class="form-actions">
            ...
            <a href="{{ route('kajor.keluarga.index') }}" class="glass-select" style="background: transparent; color: var(--text-main); border: 1px solid var(--text-muted); padding: 0.8rem 1.5rem; font-weight: 500; text-decoration: none; display: inline-flex; align-items: center; gap: 0.5rem;">
