...
@section('title', 'Detail Usaha - ' . $bisnis->nama_usaha)
...
<div style="display: flex; justify-content: space-between; align-items: flex-start; flex-wrap: wrap; gap: 0.75rem; margin-bottom: 2rem;">
    <div>
        ...
        <a href="{{ route('kajor.bisniskos.index') }}" style="color: #999; text-decoration: none;">
            <i class="ri-arrow-left-line"></i> Kembali ke Daftar
        </a>
    </div>
    <div style="display: flex; gap: 1rem; flex-wrap: wrap;">
        <a href="{{ route('kajor.bisniskos.print', $bisnis->id) }}" target="_blank" class="btn-action" style="background: rgba(16, 185, 129, 0.2); color: #10b981;">
