...
<body>
    ...
    <div class="header-left">
        <div class="sub"><span class="label">Jorong</span>: <strong>{{ ucwords(strtolower($jorongName)) }}</strong></div>
    ...
    <div class="signature-section">
        ...
        <div class="signature-box">
            <div class="jabatan"><br>Pelapor,</div>
            <div class="jabatan"><br>Kepala Jorong {{ ucwords(strtolower($jorongName)) }}</div>
    ...
    <div class="print-info">
        Dicetak pada: {{ now()->format('d F Y H:i:s') }} | Jorong {{ ucwords(strtolower($jorongName)) }}
    </div>
