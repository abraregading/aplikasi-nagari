...
@section('title', 'Profil Saya - Kepala Jorong')
...
<div class="profile-card">
    ...
    @if($user->jorong)
        <p style="margin-top: 0.5rem; font-size: 0.9rem;">Jorong: {{ $user->jorong }}</p>
    @endif
</div>
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 2rem;">
    ...
    <div class="glass" style="padding: 2rem; border-radius: 16px;">
        ...
        <form action="{{ route('kajor.profil.updateProfile') }}" method="POST">
            @csrf
            @method('PUT')
    ...
    <div class="glass" style="padding: 2rem; border-radius: 16px;">
        ...
        <form action="{{ route('kajor.profil.updatePassword') }}" method="POST">
            @csrf
            @method('PUT')
