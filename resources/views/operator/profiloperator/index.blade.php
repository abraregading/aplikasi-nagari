...
@section('title', 'Profil Saya - Operator')
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(400px, 1fr)); gap: 2rem;">
    ...
    <div class="glass" style="padding: 2rem; border-radius: 16px;">
        ...
        <form action="{{ route('operator.profil.updateProfile') }}" method="POST">
            @csrf
            @method('PUT')
    ...
    <div class="glass" style="padding: 2rem; border-radius: 16px;">
        ...
        <form action="{{ route('operator.profil.updatePassword') }}" method="POST">
            @csrf
            @method('PUT')
