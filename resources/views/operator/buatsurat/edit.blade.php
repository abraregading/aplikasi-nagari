...
<form action="{{ route('buatsurat.update', $surat->id) }}" method="POST">
    @csrf
    @method('PUT')
    ...
    <div class="form-card glass">
        ...
        @include($formTemplate, ['jenisSurat' => $jenisSurat ?? null, 'dataSurat' => $dataSurat ?? [], 'surat' => $surat])
        ...
        <div class="form-section">
            ...
            <div class="form-row full">
                <div class="form-group">
                    ...
                    <textarea name="keterangan" class="form-control" placeholder="Contoh: Tidak Mampu, Berkelakuan Baik, Domisili, dll." required>{{ old('keterangan', $surat->keterangan) }}</textarea>
                </div>
            </div>
            <div class="form-row full">
                <div class="form-group">
                    <label>Pernyataan / Keperluan</label>
                    <textarea name="pernyataan" class="form-control" placeholder="Contoh: persyaratan pengurusan bantuan sosial">{{ old('pernyataan', $surat->pernyataan) }}</textarea>
                </div>
            </div>
        </div>
        @endif
