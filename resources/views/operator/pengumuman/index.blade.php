...
<div class="glass" style="padding: 2rem; border-radius: 16px;">
    <a href="{{ route('operator.pengumuman.create') }}" style="background:var(--primary); color:white; border:none; padding:0.8rem 1.5rem; border-radius:8px; cursor:pointer; display:inline-flex; align-items:center; gap:.5rem; text-decoration:none;">
        ...
        <table id="example" class="display" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('operator.pengumuman.edit', $p->id) }}" class="glass-select" style="background: rgba(245, 158, 11, 0.15); color: #f59e0b; border: 1px solid rgba(245, 158, 11, 0.25); padding: 0.4rem 0.8rem; font-size: 0.8rem; font-weight: 500; text-decoration: none; display: inline-flex; align-items: center; gap: 0.3rem;">
                            <i class="ri-edit-line"></i> Edit
                        </a>
                        <form action="{{ route('operator.pengumuman.destroy', $p->id) }}" method="POST" style="display: inline;">
                            @csrf
                            @method('DELETE')
