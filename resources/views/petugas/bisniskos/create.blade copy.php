        ...
        <form method="POST" action="{{ route('petugas.bisniskos.store') }}">
            ...
            <div class="form-row-3">
                <div class="form-group">
                    ...
                    <input type="text" name="rt" id="rt" class="form-control" value="{{ old('rt') }}" placeholder="RT">
                </div>
                <div class="form-group">
                    <label for="rw">RW</label>
                    <input type="text" name="rw" id="rw" class="form-control" value="{{ old('rw') }}" placeholder="RW">
                </div>
                <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="fasilitas" id="fasilitas" class="form-control" value="{{ old('fasilitas') }}" placeholder="Contoh: AC, Wifi, Kamar Mandi Dalam">
            </div>

            <div class="form-row">
                <div class="form-group">
                    <label for="harga_sewa_min">Harga Sewa Min (Rp)</label>
                    <input type="number" name="harga_sewa_min" id="harga_sewa_min" class="form-control" value="{{ old('harga_sewa_min') }}" min="0" placeholder="Harga terendah">
                </div>
                <div class="form-group">
                    <label for="harga_sewa_max">Harga Sewa Max (Rp)</label>
                    <input type="number" name="harga_sewa_max" id="harga_sewa_max" class="form-control" value="{{ old('harga_sewa_max') }}" min="0" placeholder="Harga tertinggi">
                </div>
            </div>
