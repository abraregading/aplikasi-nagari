...
class DatakeluargaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.datakeluarga.index', compact('profil', 'keluargas'));
    }
    ...
    {
        $profil = ProfilNagari::pluck('setting_value', 'setting_key')->toArray();
        return view('admin.datakeluarga.create', compact('profil'));
    }
    ...
    public function store(Request $request)
    {
        ...
        Keluarga::create($request->only([
            'no_kk', 'kepala_keluarga_nik', 'alamat', 'rt', 'rw', 'jorong',
            'desa_kelurahan', 'kecamatan', 'kabupaten_kota', 'provinsi',
            'kode_pos', 'jumlah_anggota', 'status',
        ]));

        return redirect()->route('data-keluarga.index')->with('success', 'Data keluarga berhasil ditambahkan.');
    }
    ...
    public function show(string $id)
    {
        ...
        return view('admin.datakeluarga.show', compact('profil', 'keluarga'));
    }
    ...
    public function edit(string $id)
    {
        $profil = ProfilNagari::pluck('setting_value', 'setting_key')->toArray();
        $keluarga = Keluarga::findOrFail($id);
        return view('admin.datakeluarga.edit', compact('profil', 'keluarga'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('data-keluarga.index')->with('success', 'Data keluarga berhasil diperbarui.');
    }
